...
import nusiss.swe5006.team12.todolist.domain.Notification;
import nusiss.swe5006.team12.todolist.repository.NotificationRepository;
...
/**
 * REST controller for managing {@link nusiss.swe5006.team12.todolist.domain.Notification}.
 */
@RestController
    ...
    public ResponseEntity<Notification> partialUpdateNotification(
        ...
        Optional<Notification> result = notificationRepository
            ...
            .map(existingNotification -> {
                ...
                if (notification.getAlertTime() != null) {
                    existingNotification.setAlertTime(notification.getAlertTime());
                }
                if (notification.getDisableNotification() != null) {
                    existingNotification.setDisableNotification(notification.getDisableNotification());
                }
