...
import workSpaceResolve from './work-space-routing-resolve.service';

describe('WorkSpace routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: WorkSpaceService;
  let resultWorkSpace: IWorkSpace | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IWorkSpace returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        workSpaceResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultWorkSpace).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IWorkSpace>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
