...
import { EntityArrayResponseType, WorkSpaceService } from '../service/work-space.service';
...
export class WorkSpaceComponent implements OnInit {
  ...
  trackId = (item: IWorkSpace): number => this.workSpaceService.getWorkSpaceIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.workSpaces().length === 0) {
            ...
            this.workSpaces.set(this.refineData(this.workSpaces()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.workSpaces.set(this.refineData(dataFromBody));
  }
