...
import static nusiss.swe5006.team12.todolist.domain.NotificationAsserts.*;
...
class NotificationResourceIT {
    ...
    private static final LocalDate DEFAULT_ALERT_TIME = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_ALERT_TIME = LocalDate.now(ZoneId.systemDefault());

    private static final Boolean DEFAULT_DISABLE_NOTIFICATION = false;
    private static final Boolean UPDATED_DISABLE_NOTIFICATION = true;
    ...
    public static Notification createEntity() {
        return new Notification().message(DEFAULT_MESSAGE).alertTime(DEFAULT_ALERT_TIME).disableNotification(DEFAULT_DISABLE_NOTIFICATION);
    }
    ...
    public static Notification createUpdatedEntity() {
        return new Notification().message(UPDATED_MESSAGE).alertTime(UPDATED_ALERT_TIME).disableNotification(UPDATED_DISABLE_NOTIFICATION);
    }
    ...
    void checkAlertTimeIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        notification.setAlertTime(null);
    ...
    void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.[*].disableNotification").value(hasItem(DEFAULT_DISABLE_NOTIFICATION)));
    }
    ...
    void getNotification() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.disableNotification").value(DEFAULT_DISABLE_NOTIFICATION));
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.message(UPDATED_MESSAGE).alertTime(UPDATED_ALERT_TIME).disableNotification(UPDATED_DISABLE_NOTIFICATION);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.disableNotification(UPDATED_DISABLE_NOTIFICATION);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.message(UPDATED_MESSAGE).alertTime(UPDATED_ALERT_TIME).disableNotification(UPDATED_DISABLE_NOTIFICATION);
